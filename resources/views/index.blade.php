...
<head>
    ...
    <title>Home | My Hospital - Your Well Being Is Our Responsibility</title>

    <!-- Meta Description Tag -->

    <meta name="Description" content=" My Hospital - Your Well Being Is Our Responsibility">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-5 d-none d-sm-none d-md-block d-lg-block d-xl-block">
                    ...
                    <div class="hdr-center-account text-left p-0">
                        ...
                        <a class="font-14 mr-4" href="#"><i class="fa fa-ambulance"></i>Get To Know Us</a>

                        <a class="font-14" href="#"><i class="fa fa-user-md"></i>Book An Appointment</a>
                ...
                <div class="col">
                    ...
                    <div class="hdr-center-logo text-center">
                        ...
                        <a href="index.html" class="d-inline-block">My Hospital<!--<img src="images/logo.png" alt="">--></a>
                                ...
                                <li class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="doctors-1.html">Doctor 1</a></li>

                                            <li><a href="doctors-2.html">Doctor 2</a></li>

                                            <li><a href="doctors-3.html">Doctor 3</a></li>
											
                                            <li><a href="doctors-3.html">See more doctors</a></li>											
                                    ...
                                    <div class="col-lg-8 d-none d-sm-none s-md-none d-lg-block d-xl-block">
            ...
            <ul class="slides">     
                ...
                <li>
                    ...
                    <div class="slider-info">
                        ...
                        <h1 class="animated fadeInDown">Providing Quality Medical Services. Our Vision</h1>

                        <p class="animated fadeInDown">This is tag line ipsum dolor sit amet, consectetur Nihil cupiditate. mollitia maiores temp fugit! Lorem ipsum dolor sit amet, consectetur adipisicing elit#twitterhash, @facebooktag</p>
                ...
                <li>
                    ...
                    <div class="slider-info">
                        ...
                        <h2>Your Well Being. Our Responsibility</h2>
        ...
        <div class="layer-wrapper">
            ...
            <div class="layer-container row">
                ...
                <div class="hm-service-right col-md-7">
                    ...
                    <p class="paragraph-medium paragraph-black">My Hospital provides medical services and consultations. The best in various fields of medicine and hospitality.</p>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="theme-block theme-block-hover">
                        ...
                        <div class="theme-block-picture">
                            ...
                            <div class="blog-card-date">22 Mar 2018</div>
                        ...
                        <div class="blog-card-details">
                            ...
                            <p><i class="fa fa-user"></i>My Hospital</p>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="theme-block theme-block-hover">
                        ...
                        <div class="theme-block-picture">
                            ...
                            <div class="blog-card-date">21 Mar 2018</div>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="theme-block theme-block-hover">
                        ...
                        <div class="theme-block-picture">
                            ...
                            <div class="blog-card-date">20 Mar 2018</div>
        ...
        <div class="layer-stretch">
            ...
            <div class="layer-wrapper">
                ...
                <div class="layer-container">
                    ...
                    <div class="emergency-number">Call : +2348024435768</div>
    ...
    <footer id="footer">
                        ...
                        <div class="tbl">
                            ...
                            <div class="tbl-row">
                                ...
                                <div class="tbl-cell">
                                    ...
                                    <p class="paragraph-medium paragraph-white">+23408079834652</p>
                            ...
                            <div class="tbl-row">
                                ...
                                <div class="tbl-cell">
                                    ...
                                    <p class="paragraph-medium paragraph-white">hello@myhospital.com</p>
        ...
        <div id="copyright">
            ...
            <div class="layer-stretch">
                ...
                <div class="paragraph-medium paragraph-white">2018 © My Hospital ALL RIGHTS RESERVED.</div>
